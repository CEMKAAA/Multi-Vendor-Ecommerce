<!-- Quick-view-Modal -->
    ...
    <div class="select-dummy-wrapper">
        <select id="compute-select">
            <option id="compute-option">Tümü</option>
        </select>
    </div>
    <!-- Dummy Selectbox /- -->
    <!-- Responsive-Search -->
    <div class="responsive-search-wrapper">
        ...
        <div class="responsive-search-container">
            <div class="container">
                <p>Aramak için yaz ve enter`a tıkla</p>
                <form class="responsive-search-form">
                    <label class="sr-only" for="search-text">Ara</label>
                    <input id="search-text" type="text" class="responsive-search-field" placeholder="Arayın">
                    ...
                    <div class="row align-items-center u-s-m-x-0">
                        <div class="col-lg-6 col-md-6 col-sm-12 u-s-p-x-0">
                            <div class="newsletter-image">
                                <a target="_blank" rel="nofollow" href="https://www.youtube.com/@ahmetbilgehanciraci2869/videos" class="banner-hover effect-dark-opacity">
                                    <img class="img-fluid" src="{{ asset('front/image/banners/stack-developers-modal-popup.png') }}" alt="Newsletter Image">
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="newsletter-wrapper">
                                <h1>Sitemize yeni misin
                                    <span></span> ?
                                    <br>Abone olun ve</h1>
                                <h5>En son gelişmelerden haberdar olun</h5>
                                <form>
                                    <div class="u-s-m-b-35">
                                        <input type="text" class="newsletter-textfield" placeholder="email addresinizi giriniz">
                                    </div>
                                    <div class="u-s-m-b-35">
                                        <button class="button button-primary d-block w-100">Abone ol</button>
                                    </div>
                                </form>
                                <h6>En son gelişmelerden ilk siz haberdar olun</h6>
                            </div>
                        </div>
                    </div>
                </div>
